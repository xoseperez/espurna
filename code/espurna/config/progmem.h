...
PROGMEM const char espurna_ota_modules[] =
        ...
        "ASYNCTCP "
    #endif
    #if (OTA_CLIENT == OTA_CLIENT_HTTPUPDATE) && (SECURE_CLIENT == SECURE_CLIENT_NONE)
        "*HTTPUPDATE "
    #endif
    #if (OTA_CLIENT == OTA_CLIENT_HTTPUPDATE) && (SECURE_CLIENT == SECURE_CLIENT_AXTLS)
        "*HTTPUPDATE_AXTLS "
    #endif
    #if (OTA_CLIENT == OTA_CLIENT_HTTPUPDATE) && (SECURE_CLIENT == SECURE_CLIENT_BEARSSL)
        "*HTTPUPDATE_BEARSSL "
    #endif
    #if OTA_MQTT_SUPPORT
        "MQTT "
