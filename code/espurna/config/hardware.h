...
#elif defined(SMARTLIFE_T1_2CH)
//used pins 2 3 5 12 13 15 16
//free pins 14 0 4
    // Info
    #define MANUFACTURER        "SMARTLIFE"
    #define DEVICE              "SMARTLIFE_T1_2CH"
  ...
  #elif defined(VHOME_DISP)
    //used pins 2 4 5 12 13 15 16
    //free pins 14

    // Info
    #define MANUFACTURER        "VHOME"
    #define DEVICE              "VHOME_DISP"
