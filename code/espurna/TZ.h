...
typedef struct { 
    ...
    // America/Santarem = 12
    {"<-04>",-240, "<-03>", -180, 8, 2, 6, 0, 5, 2, 6, 0}, // America/Santiago = 31
    ...
    // Asia/Phnom_Penh = 36
    // Asia/Pontianak = 54
    {"KST",540, NULL, 0, 0, 0, 0, 0, 0, 0}, // Asia/Pyongyang = 63
    // Asia/Qatar = 41
    // Asia/Qyzylorda = 43
    // Asia/Riyadh = 41
    // Asia/Sakhalin = 38
    ...
    // Asia/Tashkent = 39
    // Asia/Tbilisi = 46
    {"<+0330>",210, "<+0430>", 270, 0, 3, 0, 360, 30, 0, 0, 120}, // Asia/Tehran = 64
    // Asia/Thimphu = 43
    {"JST",540, NULL, 0, 0, 0, 0, 0, 0, 0}, // Asia/Tokyo = 65
    // Asia/Tomsk = 36
    // Asia/Ulaanbaatar = 35
    // Asia/Urumqi = 43
    // Asia/Ust-Nera = 37
    ...
    // Asia/Vladivostok = 37
    // Asia/Yakutsk = 48
    {"<+0630>",390, NULL, 0, 0, 0, 0, 0, 0, 0}, // Asia/Yangon = 66
    // Asia/Yekaterinburg = 39
    // Asia/Yerevan = 46
    // Atlantic/Azores = 33
    // Atlantic/Bermuda = 26
    {"WET",0, "WEST", 60, 3, 5, 0, 60, 10, 5, 0, 120}, // Atlantic/Canary = 67
    {"<-01>",-60, NULL, 0, 0, 0, 0, 0, 0, 0}, // Atlantic/Cape_Verde = 68
    // Atlantic/Faroe = 67
    // Atlantic/Madeira = 67
    ...
    {"ACST",570, "ACDT", 630, 10, 1, 0, 120, 4, 1, 0, 180}, // Australia/Adelaide = 69
    {"AEST",600, NULL, 0, 0, 0, 0, 0, 0, 0}, // Australia/Brisbane = 70
    // Australia/Broken_Hill = 69
    {"AEST",600, "AEDT", 660, 10, 1, 0, 120, 4, 1, 0, 180}, // Australia/Currie = 71
    {"ACST",570, NULL, 0, 0, 0, 0, 0, 0, 0}, // Australia/Darwin = 72
    {"<+0845>",525, NULL, 0, 0, 0, 0, 0, 0, 0}, // Australia/Eucla = 73
    // Australia/Hobart = 71
    // Australia/Lindeman = 70
    {"<+1030>",630, "<+11>", -11, 10, 1, 0, 120, 4, 1, 0, 120}, // Australia/Lord_Howe = 74
    // Australia/Melbourne = 71
    {"AWST",480, NULL, 0, 0, 0, 0, 0, 0, 0}, // Australia/Perth = 75
    // Australia/Sydney = 71
    // Europe/Amsterdam = 7
    // Europe/Andorra = 7
    // Europe/Astrakhan = 46
    ...
    // Europe/Budapest = 7
    // Europe/Busingen = 7
    {"EET",120, "EEST", 180, 3, 5, 0, 120, 10, 5, 0, 180}, // Europe/Chisinau = 76
    // Europe/Copenhagen = 7
    {"IST",60, "GMT", 120, 10, 5, 0, 120, 3, 5, 0, 60}, // Europe/Dublin = 77
    // Europe/Gibraltar = 7
    {"GMT",0, "BST", 60, 3, 5, 0, 60, 10, 5, 0, 120}, // Europe/Guernsey = 78
    // Europe/Helsinki = 51
    // Europe/Isle_of_Man = 78
    // Europe/Istanbul = 41
    // Europe/Jersey = 78
    ...
    // Europe/Minsk = 41
    // Europe/Monaco = 7
    {"MSK",180, NULL, 0, 0, 0, 0, 0, 0, 0}, // Europe/Moscow = 79
    // Europe/Oslo = 7
    // Europe/Paris = 7
    // Europe/Podgorica = 7
    // Europe/Prague = 7
    ...
    // Indian/Mayotte = 1
    // Indian/Reunion = 46
    {"<+13>",780, "<+14>", 840, 9, 5, 0, 180, 4, 1, 0, 240}, // Pacific/Apia = 80
    // Pacific/Auckland = 40
    // Pacific/Bougainville = 38
    {"<+1245>",765, "<+1345>", 825, 9, 5, 0, 165, 4, 1, 0, 225}, // Pacific/Chatham = 81
    // Pacific/Chuuk = 37
    {"<-06>",-360, "<-05>", -300, 8, 2, 6, 1320, 5, 2, 6, 1320}, // Pacific/Easter = 82
    // Pacific/Efate = 38
    {"<+13>",780, NULL, 0, 0, 0, 0, 0, 0, 0}, // Pacific/Enderbury = 83
    // Pacific/Fakaofo = 83
    {"<+12>",720, "<+13>", 780, 11, 1, 0, 120, 1, 2, 1, 180}, // Pacific/Fiji = 84
    // Pacific/Funafuti = 45
    {"<-06>",-360, NULL, 0, 0, 0, 0, 0, 0, 0}, // Pacific/Galapagos = 85
    {"<-09>",-540, NULL, 0, 0, 0, 0, 0, 0, 0}, // Pacific/Gambier = 86
    // Pacific/Guadalcanal = 38
    {"ST",600, NULL, 0, 0, 0, 0, 0, 0, 0}, // Pacific/Guam = 87
    {"HST",-600, NULL, 0, 0, 0, 0, 0, 0, 0}, // Pacific/Honolulu = 88
    {"<+14>",840, NULL, 0, 0, 0, 0, 0, 0, 0}, // Pacific/Kiritimati = 89
    // Pacific/Kosrae = 38
    // Pacific/Kwajalein = 45
    // Pacific/Majuro = 45
    {"<-0930>",-540, NULL, 0, 0, 0, 0, 0, 0, 0}, // Pacific/Marquesas = 90
    {"SST",-660, NULL, 0, 0, 0, 0, 0, 0, 0}, // Pacific/Midway = 91
    // Pacific/Nauru = 45
    {"<-11>",-660, NULL, 0, 0, 0, 0, 0, 0, 0}, // Pacific/Niue = 92
    // Pacific/Norfolk = 38
    // Pacific/Noumea = 38
    // Pacific/Pago_Pago = 91
    // Pacific/Palau = 48
    {"<-08>",-480, NULL, 0, 0, 0, 0, 0, 0, 0}, // Pacific/Pitcairn = 93
    // Pacific/Pohnpei = 38
    // Pacific/Port_Moresby = 37
    {"<-10>",-600, NULL, 0, 0, 0, 0, 0, 0, 0}, // Pacific/Rarotonga = 94
    // Pacific/Saipan = 87
    // Pacific/Tahiti = 94
    // Pacific/Tarawa = 45
    ...
    // Etc/GMT = 0
    // Etc/GMT-0 = 0
    {"<+01>",60, NULL, 0, 0, 0, 0, 0, 0, 0}, // Etc/GMT-1 = 95
