...
## [1.13.6] Unreleased
### Security
- [`b454cc4e`](https://github.com/xoseperez/espurna/commit/b454cc4ed8d8c15273d69ecab505445f4641689b) Web OTA: check authentication result before accepting payload ([#1812](https://github.com/xoseperez/espurna/issue/1812))
- [`43a44cf9`](https://github.com/xoseperez/espurna/commit/43a44cf96447dc2e04f0ef936573950df359889e) Authenticate /reset endpoint ([#1858](https://github.com/xoseperez/espurna/issue/1858))

### Fixed
- [`3018b9ff`](https://github.com/xoseperez/espurna/commit/3018b9ffe770209f6a522e2dd886a50eef24bbac) domoticz: fix always true relay match condition ([#1588](https://github.com/xoseperez/espurna/issue/1588))
- [`07ba3ff2`](https://github.com/xoseperez/espurna/commit/07ba3ff2d53b0d19a7aa72b5f9667c8ec009ae9a) domoticz: fix basic switch nvalue ([#1606](https://github.com/xoseperez/espurna/issues/1606))
- [`b0d47b4c`](https://github.com/xoseperez/espurna/commit/b0d47b4cd7916a2882d1e6027bdcc82d926775dd) Fix relay provider setting of Xiaomi Smart Desk Lamp ([#1627](https://github.com/xoseperez/espurna/issue/1627))
- [`91cbba34`](https://github.com/xoseperez/espurna/commit/91cbba3493fd0a89ebb60e54f8db05c28eef28cb) Update NTP ([#1642](https://github.com/xoseperez/espurna/pull/1642))
- [`49442740`](https://github.com/xoseperez/espurna/pull/1643/commits/494427402a282f846a8337ce847739d1650cd035) WebUI relayOnDisc selector typo ([#1643](https://github.com/xoseperez/espurna/pull/1643))
- [`594e9788`](https://github.com/xoseperez/espurna/commit/594e97880cb6027314e18968bd7e5e8f589c042a) fix cse7766 magnitude count ([#1665](https://github.com/xoseperez/espurna/issue/1665))
- [`eb504e5f`](https://github.com/xoseperez/espurna/commit/eb504e5f580ac44e8df1fef6619d02aefd031fa6) Fix Travis failing with INFLUXDB_SUPPORT ([#1565](https://github.com/xoseperez/espurna/issue/1565))
- [`d00c2b5e`](https://github.com/xoseperez/espurna/commit/d00c2b5eb3c91558a3bf801af3f3b8b925e04826) Fix energy storage when units different from joules ([#1335](https://github.com/xoseperez/espurna/issue/1335))
- [`3f37556c`](https://github.com/xoseperez/espurna/commit/3f37556cdd583720478120a3c36e0a66c4f78a0c) Safer loop delay default ([#1574](https://github.com/xoseperez/espurna/issue/1574), [#1631](https://github.com/xoseperez/espurna/issue/1631), [#1699](https://github.com/xoseperez/espurna/issue/1699))
- [`76066a3a`](https://github.com/xoseperez/espurna/commit/76066a3aa1c098daf9318f3ea5e1917f60232405) Fix memanalyzer out-of-range
- [`8e95632d`](https://github.com/xoseperez/espurna/commit/8e95632daf3ec7c88079c9e577e1b331a35c7146) MQTT: Reset connection timer with PubSubClient ([#1702](https://github.com/xoseperez/espurna/issue/1702))
- [`6452f177`](https://github.com/xoseperez/espurna/commit/6452f1777ec43ec4835abb007900e092c577cdfb) mqtt: remove 'connecting' flag when connected ([#1757](https://github.com/xoseperez/espurna/issue/1757))
- [`c7d46714`](https://github.com/xoseperez/espurna/commit/c7d467144a53aec3d643b5dd7dab2c3b2989ad54) PIO: patch lwip1 MTU bug in travis ([#1723](https://github.com/xoseperez/espurna/issue/1723))
- [`aac2e1e4`](https://github.com/xoseperez/espurna/commit/aac2e1e47e42f2e0851a6756e033138227c6a3a7) LED: store default settings exactly once ([#1719](https://github.com/xoseperez/espurna/issue/1719), [#1724](https://github.com/xoseperez/espurna/issue/1724))
- [`d9b9e144`](https://github.com/xoseperez/espurna/commit/d9b9e1449dd485c52c404f6770bfc4ca95fd0121) MQTT and HA brightness ([#1730](https://github.com/xoseperez/espurna/issue/1730))
- [`2da05fa9`](https://github.com/xoseperez/espurna/commit/2da05fa96efccd521cf873182d0256c87bb54b6e) Update wrong pinout on ag-l4 ([#1746](https://github.com/xoseperez/espurna/issue/1746))
- [`0f0d0b1b`](https://github.com/xoseperez/espurna/commit/0f0d0b1b34ee9acbdc200c8673f8040400afa729) Close connection in notFound callback ([#1768](https://github.com/xoseperez/espurna/issue/1768))
- [`1d133bee`](https://github.com/xoseperez/espurna/commit/1d133bee16b4c953d43959cfceede12eec389e0c) Build with platformio 4 ([#1805](https://github.com/xoseperez/espurna/issue/1805))
- [`bd007581`](https://github.com/xoseperez/espurna/commit/bd0075816202960ea032b53f44864692fb1834ed) Thingspeak: async client fixes ([#1806](https://github.com/xoseperez/espurna/issue/1806))
- [`fbf2b717`](https://github.com/xoseperez/espurna/commit/fbf2b71749307688f7258ad8235bc0f5d068e926) Backup EEPROM before performing OTA ([#1808](https://github.com/xoseperez/espurna/issue/1808), [#1809](https://github.com/xoseperez/espurna/issue/1809))
- [`8d009a66`](https://github.com/xoseperez/espurna/commit/8d009a66f59a0c6a81b65a5b8c3caf522953aaa8) Add missing DOMOTICZ\_... ifndef guards ([#1839](https://github.com/xoseperez/espurna/issue/1839))
- [`21423431`](https://github.com/xoseperez/espurna/commit/21423431ceab1a6d792d3f6ba746b3166ec6cb5b) Fixed size json payload & other WS bugfixes ([#1843](https://github.com/xoseperez/espurna/issue/1843), [#1851](https://github.com/xoseperez/espurna/issue/1851), [#1857](https://github.com/xoseperez/espurna/issue/1857))
- [`d4dea17f`](https://github.com/xoseperez/espurna/commit/d4dea17f94a6b4755fb9167f50aab3638ee7913b) Fix missing WS debug messages ([#1851](https://github.com/xoseperez/espurna/issue/1851))
- [`ef153b4e`](https://github.com/xoseperez/espurna/commit/ef153b4eff553397ff3ed104eadb1438e4443492) Core 2.6.0+ fixes ([#1852](https://github.com/xoseperez/espurna/issue/1852))
- [`c15d87a5`](https://github.com/xoseperez/espurna/commit/c15d87a517e56c6f85d24ca5d94310f8ee7fe4a3) Remove gpio 0 pinmode in analog sensor ([#1827](https://github.com/xoseperez/espurna/issue/1827))
- [`85a09a2b`](https://github.com/xoseperez/espurna/commit/85a09a2b47c55851952151469a9edb4d63d1dbca) Add #ifndef guard for BMX280\_... defines ([#1867](https://github.com/xoseperez/espurna/issue/1867))
- [`fa9ff7de`](https://github.com/xoseperez/espurna/commit/fa9ff7dee745b382fcd47ffa74be2eafe90edf9f) Check value range for PMSX005 and SenseAir CO2 sensor ([#1865](https://github.com/xoseperez/espurna/issue/1865))
- [`d66b8a9b`](https://github.com/xoseperez/espurna/commit/d66b8a9bed9b6b5b5f57badf63cb6d390b6149e5) Syncronize js when saving configuration ([#1863](https://github.com/xoseperez/espurna/issue/1863))
- [`b3600bdc`](https://github.com/xoseperez/espurna/commit/b3600bdc14e8895a93a4137dcfd798c56c47bdc8) Format fixes in light module ([#1874](https://github.com/xoseperez/espurna/issue/1874))
- [`ec259767`](https://github.com/xoseperez/espurna/commit/ec259767172d2e7217f11e1002bafc28d8d45b3c) Domoticz: handle cmode=2 ([#1880](https://github.com/xoseperez/espurna/issue/1880))
- [`c123156b`](https://github.com/xoseperez/espurna/commit/c123156b8723fa055f4197edd448cc81e7c8fa23) WiFi SoftAP fixes ([#1881](https://github.com/xoseperez/espurna/issue/1881))
- [`9d166f8a`](https://github.com/xoseperez/espurna/commit/9d166f8a30c2ef059d06e30d063352698dc8458c) MQTT: update MQTT_MAX_PACKET_SIZE to fit JSON payload ([#1888](https://github.com/xoseperez/espurna/issue/1888))
- [`26fcdd76`](https://github.com/xoseperez/espurna/commit/26fcdd76c5d70467b2ce33e83609ebe3752fb097) WiFi settings clean-up ([#1893](https://github.com/xoseperez/espurna/issue/1893))
- [`25d37f1c`](https://github.com/xoseperez/espurna/commit/25d37f1c5c1ca86211b45f3d941e2f1d7eca7c6b) Markdown Typo Fix ([#1926](https://github.com/xoseperez/espurna/issue/1926))
- [`a0fc6728`](https://github.com/xoseperez/espurna/commit/a0fc672816105a3245aef7ac6cf36210bdb4d728) Properly handle telnet negotiation ([#1927](https://github.com/xoseperez/espurna/issue/1927))
- [`d4698c0a`](https://github.com/xoseperez/espurna/commit/d4698c0a37998fe486d20ffa9326f04a083f627b) Fix inconsistent light transitions ([#1901](https://github.com/xoseperez/espurna/issue/1901), [#1923](https://github.com/xoseperez/espurna/issue/1923))

### Added
- [`820d8c4b`](https://github.com/xoseperez/espurna/commit/820d8c4be8af5cb0be1b94187a9c0ed0f6bbbb86) Initial implementation of RTCMEM storage ([#1420](https://github.com/xoseperez/espurna/issue/1420))
- [`0987e019`](https://github.com/xoseperez/espurna/commit/0987e0195041b39109f775865ac16bd14b2801a6) Allow to configure all LEDs from UI ([#1429](https://github.com/xoseperez/espurna/issue/1429))
- [`9955a67d`](https://github.com/xoseperez/espurna/commit/9955a67dbb081ddcb96b35df3b70d06d949652e6) LightFox dual support ([#1468](https://github.com/xoseperez/espurna/issue/1468))
- [`b878c713`](https://github.com/xoseperez/espurna/commit/b878c713064aa18def669efdf3bbfe3497d1fc59) Support for Digoo/Oxaoxe NX-SP202 ([#1502](https://github.com/xoseperez/espurna/issue/1502))
- [`e62d0df9`](https://github.com/xoseperez/espurna/commit/e62d0df9be411ae1e30a8c8d4e8ae8d70f0d429a) MH-Z19 auto-calibration setting ([#1580](https://github.com/xoseperez/espurna/issue/1580) , [#1592](https://github.com/xoseperez/espurna/issue/1592))
- [`b0ee48ed`](https://github.com/xoseperez/espurna/commit/b0ee48edf93de715c3c980eb0707a6d51b4e08a1) HAMA outlet model number 00176552 ([#1598](https://github.com/xoseperez/espurna/issue/1598))
- [`2832dc75`](https://github.com/xoseperez/espurna/commit/2832dc75520247be44902e0c487c4e8ab0b9b224) Allow to set relative brightness and relative color in mireds through command using +N and -N notation ([#1607](https://github.com/xoseperez/espurna/issue/1607))
- [`af07494f`](https://github.com/xoseperez/espurna/commit/af07494f0097073a550c254c33468e423805dd4a) Add thermostat module ([#1603](https://github.com/xoseperez/espurna/issue/1603))
- [`bf705b28`](https://github.com/xoseperez/espurna/commit/bf705b282f674e1f91355ca22084c3bdaf134c06) SYNC_FIRST mode ([#1609](https://github.com/xoseperez/espurna/issue/1609))
- [`8de61598`](https://github.com/xoseperez/espurna/commit/8de61598f61c141469f015ef6c8ddab093db9392) Fix ESP.eraseConfig() when using Core 2.3.0 ([#1595](https://github.com/xoseperez/espurna/issue/1595), [#1616](https://github.com/xoseperez/espurna/issue/1616))
- [`ea5bd90c`](https://github.com/xoseperez/espurna/commit/ea5bd90cc76811a7351d77bf52dba7c5ce86de4d) Added LITESUN LA-WF3 support. ([#1618](https://github.com/xoseperez/espurna/issue/1618))
- [`33945e4c`](https://github.com/xoseperez/espurna/commit/33945e4ca892737a8d2624628684c0ea7d131bfb) Added Teckin SP20 Power Plug. ([#1611](https://github.com/xoseperez/espurna/issue/1611))
- [`b9029020`](https://github.com/xoseperez/espurna/commit/b9029020a5f268e084f6a19ba7f56d73bb275c89) CSE7766: Add reactive power calculation ([#1591](https://github.com/xoseperez/espurna/issue/1591))
- [`a072ada7`](https://github.com/xoseperez/espurna/commit/a072ada7ae147b0ff190f542a7e4394fcb19300a) Add option to disable relay reporting to MQTT ([#1645](https://github.com/xoseperez/espurna/issue/1645))
- [`c3a0a701`](https://github.com/xoseperez/espurna/commit/c3a0a701c2986ff1485d6546938cc811558ae3c2) Adding support for Generic GU10 from [#1549](https://github.com/xoseperez/espurna/issue/1549) ([#1650](https://github.com/xoseperez/espurna/issue/1650))
- [`175fcbf6`](https://github.com/xoseperez/espurna/commit/175fcbf6cfa99603d49de010876d32635f65b863) Support for WPS in core build. Using UNUSED macro to prevent warnings
- [`f2ad3715`](https://github.com/xoseperez/espurna/commit/f2ad37152be72486a732d1021249dca8428e73d8) special dummy printf to disable Serial using some boards ([#1664](https://github.com/xoseperez/espurna/issue/1664))
- [`67324874`](https://github.com/xoseperez/espurna/commit/6732487469be3ae91d2f13a0543e1034c431be94) MAX6675: default pins and SENSOR_SUPPORT dependency ([#1646](https://github.com/xoseperez/espurna/issue/1646), [#1666](https://github.com/xoseperez/espurna/issue/1666))
- [`0b73882f`](https://github.com/xoseperez/espurna/commit/0b73882fa0e286df96fb43daeb26d3e7f6ea4435) Add `bmx280Number` and `bmx280Address` settings ([#1690](https://github.com/xoseperez/espurna/issue/1690))
- [`193cebdb`](https://github.com/xoseperez/espurna/commit/193cebdbab7a6081812c08af78ec8f9607dca481) RF/RFBRIDGE Update ([#1693](https://github.com/xoseperez/espurna/issue/1693))
- [`334b4990`](https://github.com/xoseperez/espurna/commit/334b4990241f2484c9638a4d0a268832fda010b5) Safer settings reload and MQTT change detection ([#1701](https://github.com/xoseperez/espurna/issue/1701))
- [`62a2b9e8`](https://github.com/xoseperez/espurna/commit/62a2b9e88241043d410fa3664c4c2cb7f5b1f695) PZEM004T: settings & dev board ([#1712](https://github.com/xoseperez/espurna/issue/1712))
- [`55b9f2a5`](https://github.com/xoseperez/espurna/commit/55b9f2a52f9fc5a225ae4880d15893d15161209f) Send Vcc, LoadAvg and Ssid to influxdb ([#1714](https://github.com/xoseperez/espurna/issue/1714))
- [`471a6387`](https://github.com/xoseperez/espurna/commit/471a6387fb61e159df5d075a8ef7cf74be838ffd) Separate device name for alexa integration ([#1727](https://github.com/xoseperez/espurna/issue/1727))
- [`9ceca447`](https://github.com/xoseperez/espurna/commit/9ceca44770cc7772afc020ce7bad2d4cf321eadb) Two channel CCT ([#1732](https://github.com/xoseperez/espurna/issue/1732))
- [`21b0ac04`](https://github.com/xoseperez/espurna/commit/21b0ac04df9e6c675d36cdc76b0425f81fd4f3e8) MQTT: send mired if cct in use ([#1742](https://github.com/xoseperez/espurna/issue/1742))
- [`5ca44c1c`](https://github.com/xoseperez/espurna/commit/5ca44c1c4cbddb94661337508f34cf2e7eba989a) mqtt: display connection state, `mqtt.info` command ([#1757](https://github.com/xoseperez/espurna/issue/1757))
- [`868d4d55`](https://github.com/xoseperez/espurna/commit/868d4d5573cabb33b3d50f88f7ff4ac2dd5b56db) Added LDR sensor (thanks to Altan Altay)
- [`075b704d`](https://github.com/xoseperez/espurna/commit/075b704d6cb3a52fe78648304ec73c94c98c5bd0) Log in travis if webui files have changed
- [`dfd3a14a`](https://github.com/xoseperez/espurna/commit/dfd3a14abc37b9965b070d39ce329d065af74eef) Terminal: heap fragmentation stat ([#1740](https://github.com/xoseperez/espurna/issue/1740))
- [`9156eb14`](https://github.com/xoseperez/espurna/commit/9156eb14772aa813a6918682a8513f1c466383de) Experimental support of HTTPUpdate for OTA ([#1751](https://github.com/xoseperez/espurna/issue/1751))
- [`14b796b4`](https://github.com/xoseperez/espurna/commit/14b796b41010abaa4f3aa17bc478dfb1631421a0) Rtcmem update ([#1770](https://github.com/xoseperez/espurna/issue/1770))
- [`bf3caf37`](https://github.com/xoseperez/espurna/commit/bf3caf37589243fbbac658eeb6436a6fe7d9ed24) add support for JINVOO VALVE SM-AW713 ([#1774](https://github.com/xoseperez/espurna/issue/1774))
- [`dc26a696`](https://github.com/xoseperez/espurna/commit/dc26a696429a66a76a3fd2d643d3e8cdb9f4a288) Add support for MagicHome RGBWW LED strip ([#1787](https://github.com/xoseperez/espurna/issue/1787))
- [`36f6c822`](https://github.com/xoseperez/espurna/commit/36f6c822ad491e938cda5ab1c960e0d2adffc303) Configure WEB_REMOTE_DOMAIN at runtime ([#1789](https://github.com/xoseperez/espurna/issue/1789))
- [`746ad706`](https://github.com/xoseperez/espurna/commit/746ad7062dfdaa0a8c58e86d3fc0ad56fe040084) Add config for push button of Arilux AL-LC06 ([#1794](https://github.com/xoseperez/espurna/issue/1794))
- [`3fb34c1c`](https://github.com/xoseperez/espurna/commit/3fb34c1cc4aaa5ea8e5856032e21b564a6033301) Add ability to print all GPIO values at once ([#1798](https://github.com/xoseperez/espurna/issue/1798))
- [`ff046eb0`](https://github.com/xoseperez/espurna/commit/ff046eb0f1b480512878edaaa88263e0be5456e7) DEBUG_SUPPORT check for crashSetup ([#1807](https://github.com/xoseperez/espurna/issue/1807))
- [`a8f602a4`](https://github.com/xoseperez/espurna/commit/a8f602a401cb3ad6dff0f8f916181b4b4018209c) Use basic BearSSL ciphers on low memory boards ([#1810](https://github.com/xoseperez/espurna/issue/1810))
- [`9be43c36`](https://github.com/xoseperez/espurna/commit/9be43c364a4e2f3b5460000c0157cfcd7dd3d6bf) Telnet/WiFiServer: alternative to ESPAsyncTCP ([#1799](https://github.com/xoseperez/espurna/issue/1799))
- [`ee8a6e02`](https://github.com/xoseperez/espurna/commit/ee8a6e022a2766c41c9c7d425150537bbcc14806) Nexete A19 RGBW bulb ([#1814](https://github.com/xoseperez/espurna/issue/1814))
- [`8dac0bbe`](https://github.com/xoseperez/espurna/commit/8dac0bbe49fcf598c35a120cc5a35394d6f2b350) Build date in ota.py (mDNS) ([#1736](https://github.com/xoseperez/espurna/issue/1736))
- [`2e8ff3ab`](https://github.com/xoseperez/espurna/commit/2e8ff3ab3dc5c23d6ef55ce6c75f7a81b539906f) Add Shelly 1PM ([#1822](https://github.com/xoseperez/espurna/issue/1822))
- [`f8a0b993`](https://github.com/xoseperez/espurna/commit/f8a0b9935c2388954871edff0ccf25f0688f0d54) Terminal: Add description for each channel ([#1826](https://github.com/xoseperez/espurna/issue/1826))
- [`c8547fa7`](https://github.com/xoseperez/espurna/commit/c8547fa728d653c491fda91fe595b8a7e9761b1f) Add itead-sonoff-s31-lite ([#1830](https://github.com/xoseperez/espurna/issue/1830))
- [`7e536be7`](https://github.com/xoseperez/espurna/commit/7e536be79c790a9b5b7f8031e9d80fc38fe18a0a) Add iselector-sm-pw702 ([#1837](https://github.com/xoseperez/espurna/issue/1837))
- [`6d74f4e9`](https://github.com/xoseperez/espurna/commit/6d74f4e95830a3700dc769e52389f6fc51e63c36) Add etekcity-esw01-usa ([#1836](https://github.com/xoseperez/espurna/issue/1836))
- [`d4311211`](https://github.com/xoseperez/espurna/commit/d4311211ad46712339aef8e51003deb02317e73a) Lock relay status on boot ([#1705](https://github.com/xoseperez/espurna/issue/1705))
- [`b48f8c14`](https://github.com/xoseperez/espurna/commit/b48f8c1440cd81dfd3de596b2c59c671c8a71e00) MQTT rewrite with SSL fixes ([#1751](https://github.com/xoseperez/espurna/issue/1751), [#1829](https://github.com/xoseperez/espurna/issue/1829))
- [`93c1dd6b`](https://github.com/xoseperez/espurna/commit/93c1dd6bf9ffba381d85148e78ee96cd65c07a57) Support Shelly 2.5 ([#1827](https://github.com/xoseperez/espurna/issue/1827))
- [`e398685b`](https://github.com/xoseperez/espurna/commit/e398685ba48e889503f344f182f1f7eb6434dd7a) MQTT: generic secureclient configuration ([#1873](https://github.com/xoseperez/espurna/issue/1873))
- [`35ce6871`](https://github.com/xoseperez/espurna/commit/35ce68710cc51fae2e185a6d5edff31a6d035002) Test: etharp_gratuitous ([#1877](https://github.com/xoseperez/espurna/issue/1877))
- [`13c1a193`](https://github.com/xoseperez/espurna/commit/13c1a193280652358e678ab92e13b20266ee00be) MQTT: Home Assistant updates and custom relay payloads ([#1885](https://github.com/xoseperez/espurna/issue/1885))
- [`50eda337`](https://github.com/xoseperez/espurna/commit/50eda3371bad52b246e30e4ccbf542de0c52ee9f) Itead Sonoff Mini support ([#1886](https://github.com/xoseperez/espurna/issue/1886))
- [`beff73ef`](https://github.com/xoseperez/espurna/commit/beff73ef8b7b22e6c170b72d11e4c2b51e6841cb) MQTT: handle custom relay status payloads ([#1889](https://github.com/xoseperez/espurna/issue/1889))
- [`24788474`](https://github.com/xoseperez/espurna/commit/24788474ad4d3f079899a3d307d5f0af7c8cbd35) Home Assistant: add color_temp_state_topic ([#1891](https://github.com/xoseperez/espurna/issue/1891))
- [`fc2e2955`](https://github.com/xoseperez/espurna/commit/fc2e29552e855928c43cbc247e521ff035447f40) Terminal: netstat and dns probing ([#1907](https://github.com/xoseperez/espurna/issue/1907))
- [`ae070b59`](https://github.com/xoseperez/espurna/commit/ae070b597355902393634ee8ee0911ffa0b8c9d4) Lights: channel value change detection ([#1914](https://github.com/xoseperez/espurna/issue/1914))
- [`1f44bf57`](https://github.com/xoseperez/espurna/commit/1f44bf5790f26c4f4aebb1ddca98bc4924610a7c) WiFi: Configure TX power ([#1915](https://github.com/xoseperez/espurna/issue/1915))
- [`bd385f9f`](https://github.com/xoseperez/espurna/commit/bd385f9fbc71bff007f8b9fe5825777b3bf03dce) ESP8266 FS-UAP1 Control board ([#1925](https://github.com/xoseperez/espurna/issue/1925))

### Changed
- [`546c8f09`](https://github.com/xoseperez/espurna/commit/494427402a282f846a8337ce847739d1650cd035) Update Copyright notice
- [`f4e3ced5`](https://github.com/xoseperez/espurna/commit/f4e3ced56a472a8ea33be91095ce16372c402474) Port PROGMEM from 2.5.0 ([#1374](https://github.com/xoseperez/espurna/issue/1374))
- [`437424aa`](https://github.com/xoseperez/espurna/commit/437424aaac28a6022124864f911b10aab2e1626f) .ld scripts refactoring ([#1559](https://github.com/xoseperez/espurna/issue/1559))
- [`886af1ad`](https://github.com/xoseperez/espurna/commit/886af1ad07eb3d12c5cfe9544c6ab9057c22f19d) domoticz: less debugging for lights code ([#1588](https://github.com/xoseperez/espurna/issue/1588))
- [`4405b419`](https://github.com/xoseperez/espurna/commit/4405b419e12d8a713fcf886ab364680db045cc53) Pin ArduinoJson version ([#1613](https://github.com/xoseperez/espurna/issue/1613))
- [`13fb5fa9`](https://github.com/xoseperez/espurna/commit/13fb5fa9294c576247a4c2eac843d9201bbcef15) Using espurna.io as CORS domain
- [`0f8f3a1d`](https://github.com/xoseperez/espurna/commit/0f8f3a1dd2e3f7d37c61ded8847042a10fdf6c30) Change from BMX280_ADDRESS2 notation to BMX280_NUMBER for number of sensors ([#1647](https://github.com/xoseperez/espurna/issue/1647))
- [`8d52078b`](https://github.com/xoseperez/espurna/commit/8d52078bcb77e4a6792d0003c908d9a870143000) Sensors can determine precision of their magnitudes ([#1648](https://github.com/xoseperez/espurna/issue/1648))
- [`b3abd0d6`](https://github.com/xoseperez/espurna/commit/b3abd0d6b3e30d6d73ec01e6f6bbe74967653e95) Send RF MQTT message with retain off ([#1679](https://github.com/xoseperez/espurna/issue/1679))
- [`24c48268`](https://github.com/xoseperez/espurna/commit/24c48268691c617e1e98e36dc657eb968989fcb4) Default to one BMX280 sensor ([#1690](https://github.com/xoseperez/espurna/issue/1690))
- [`8a5a0fb3`](https://github.com/xoseperez/espurna/commit/8a5a0fb309890824c997f365ef89fe4179e34ca5) Send status right after boot ([#1700](https://github.com/xoseperez/espurna/issue/1700))
- [`b12d6fd0`](https://github.com/xoseperez/espurna/commit/b12d6fd0016c5b750cd45ad7be035c0bb7f0a80a) Remove gosund-sp1-v23 env ([#1703](https://github.com/xoseperez/espurna/issue/1703))
- [`bb33dfd1`](https://github.com/xoseperez/espurna/commit/bb33dfd1023d78b28cc67436e6cb9b9fa01b8412) Thermostat upgrade ([#1711](https://github.com/xoseperez/espurna/issue/1711))
- [`b5b01a23`](https://github.com/xoseperez/espurna/commit/b5b01a2376189a8a0f6bb2f66139a49566045e9f) Small desegin change in memanalyzer output
- [`05f68218`](https://github.com/xoseperez/espurna/commit/05f682189e4b4b8dac5e4aa70e2133e9d9b9f7df) Update PlatformIO Core versions ([#1734](https://github.com/xoseperez/espurna/pull/1734))
- [`9f478e7b`](https://github.com/xoseperez/espurna/commit/9f478e7bb9d49ea86924372cbccdc20db8a734eb) Rename NTC/LDR_SENSOR to NTC/LDR_SUPPORT ([#1758](https://github.com/xoseperez/espurna/issue/1758))
- [`c44c74f7`](https://github.com/xoseperez/espurna/commit/c44c74f70e6220671a43ba555888d3c0ea55a597) Import Encoder library ([#1769](https://github.com/xoseperez/espurna/issue/1769))
- [`0d76910b`](https://github.com/xoseperez/espurna/commit/0d76910b6dd4009906155046e5b290454dda814f) Update EventsSensor ([#1771](https://github.com/xoseperez/espurna/issue/1771))
- [`dc3a572f`](https://github.com/xoseperez/espurna/commit/dc3a572f29680865f34ba311ab0fd4eec46fda89) Let JustWifi fallback handle AP ([#1784](https://github.com/xoseperez/espurna/issue/1784))
- [`88b8fcc9`](https://github.com/xoseperez/espurna/commit/88b8fcc9e4ca91fef3a669e2ea85c0c7dad9a3d3) Start SmartConfig without any networks configured ([#1785](https://github.com/xoseperez/espurna/issue/1785))
- [`0dbfce14`](https://github.com/xoseperez/espurna/commit/0dbfce1444a79f08ee61a3213aa4c88f95e1045c) Show Core revision as hex string ([#1786](https://github.com/xoseperez/espurna/issue/1786))
- [`aac36d9b`](https://github.com/xoseperez/espurna/commit/aac36d9b0cf524d4983e6eab27b45be81323fe2b) Update debugSend / debugSend_P ([#1788](https://github.com/xoseperez/espurna/issue/1788))
- [`08a748e0`](https://github.com/xoseperez/espurna/commit/08a748e05d356209963aadb2768d19e0a40d9713) Update crash handler ([#1796](https://github.com/xoseperez/espurna/issue/1796))
- [`5e091ec5`](https://github.com/xoseperez/espurna/commit/5e091ec5a969ef6acbbb4d59b2713cd3f44bfe43) Relay: drop legacy settings migration ([#1797](https://github.com/xoseperez/espurna/issue/1797))
- [`d09b3f15`](https://github.com/xoseperez/espurna/commit/d09b3f156f853fab4b6f4cb53dc98946978ae4b1) Update ESPAsyncTCP to 7e9ed22 ([#1752](https://github.com/xoseperez/espurna/issue/1752), [#1806](https://github.com/xoseperez/espurna/issue/1806))
- [`900bcb8b`](https://github.com/xoseperez/espurna/commit/900bcb8bf17f268e4df1cbcf6cff34dede02a361) PIO4: default_envs ([#1793](https://github.com/xoseperez/espurna/issue/1793))
- [`9bae101e`](https://github.com/xoseperez/espurna/commit/9bae101ed174823a1d6050301afa8befcf4e1e02) PIO: Update for recent platforms ([#1811](https://github.com/xoseperez/espurna/issue/1811))
- [`3bb5cc87`](https://github.com/xoseperez/espurna/commit/3bb5cc879f644b189a1dbbd233c0e5b99e92d3c3) Make compilation more flexible ([#1816](https://github.com/xoseperez/espurna/issue/1816))
- [`c9187919`](https://github.com/xoseperez/espurna/commit/c918791920d8ba05959f324a580a95219f9a2ac7) Light: split RGBWW and only W brightness ([#1826](https://github.com/xoseperez/espurna/issue/1826))
- [`5883617e`](https://github.com/xoseperez/espurna/commit/5883617ee697b509d305fdb485a28f1f691db138) Light: move gamma to PROGMEM ([#1826](https://github.com/xoseperez/espurna/issue/1826))
- [`228fba5b`](https://github.com/xoseperez/espurna/commit/228fba5b3a6e2c3104bf9dc4c041e4f55ccb48c9) Enable multiple Digital & Events sensors ([#1832](https://github.com/xoseperez/espurna/issue/1832))
- [`58401c8a`](https://github.com/xoseperez/espurna/commit/58401c8a616ff68bab792c19be74e3e761c6b815) Use indexed keys for energy saving ([#1875](https://github.com/xoseperez/espurna/issue/1875))
- [`68270310`](https://github.com/xoseperez/espurna/commit/68270310c7ed7d292009b4d364ee989882a42e63) Web: parse host query via browser api, logging ([#1901](https://github.com/xoseperez/espurna/issue/1901))
- [`0bf07f16`](https://github.com/xoseperez/espurna/commit/0bf07f166e71ce1d0d92e0a458c4624f03ec88c8) Web: update to jquery 3.4.1 and wheelcolorpicker 3.0.8 ([#1901](https://github.com/xoseperez/espurna/issue/1901))
- [`a2688ec3`](https://github.com/xoseperez/espurna/commit/a2688ec3766ffc1e0ed65b1b232200eac332ca01) Lights: don't show v for hsv picker, use brightness instead ([#1901](https://github.com/xoseperez/espurna/issue/1901))
- [`054a9a5e`](https://github.com/xoseperez/espurna/commit/054a9a5ea7b02e596d1835e7097f2e0df41fa121) Lights: fix kelvin/mired const naming ([#1902](https://github.com/xoseperez/espurna/issue/1902))
- [`c0c53492`](https://github.com/xoseperez/espurna/commit/c0c534926b5720fffa5593629e96fcee5395c858) Light: store pwm consts as progmem data ([#1906](https://github.com/xoseperez/espurna/issue/1906))
- [`ae070b59`](https://github.com/xoseperez/espurna/commit/ae070b597355902393634ee8ee0911ffa0b8c9d4) Lights: channel value change detection ([#1914](https://github.com/xoseperez/espurna/issue/1914))
- [`5d5f0f8b`](https://github.com/xoseperez/espurna/commit/5d5f0f8b8cea987a45b2e33779a12176b151429b) Light: schedule provider update on loop ([#1901](https://github.com/xoseperez/espurna/issue/1901), [#1923](https://github.com/xoseperez/espurna/issue/1923))
